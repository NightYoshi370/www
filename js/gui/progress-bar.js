...
me.ProgressBar = me.Renderable.extend({
	...
	init: function(x, y, w, h, padding) {
		...
		// TODO: Dynamically adjust the font size according to our size
	...
	draw : function(renderer) {
		renderer.fillRect(this.pos.x, this.pos.y, this.width, this.height, this.backgroundColor); // Draw the bottom bar (external rectangle)
		renderer.fillRect(this.pos.x + this.progressPadding.x, this.pos.y + this.progressPadding.y, this.progressWidth - this.progressPadding.x * 2, this.height - this.progressPadding.y * 2, this.foregroundColor);
		...
		this.font.draw(context, this.text, this.pos.x + this.progressPadding.x + 2, this.pos.y + this.progressPadding.y);
	},
